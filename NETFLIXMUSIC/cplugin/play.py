...
from NETFLIXMUSIC.utils.inline import panel_markup_clone
...
from NETFLIXMUSIC.utils.decorators.play import CPlayWrapper
...
async def playforce_command(client, message: Message):
    ...
    try:
        ...
        return await message.reply_text("❌ Unable to check admin status!")

    # If user is an admin, allow the playforce command
    await message.reply_text("✅ You are an admin, executing the playforce command...")
    # Add the actual playforce logic here
...
import config
from NETFLIXMUSIC import Carbon, YouTube
