...
from pyrogram.errors import RPCError  # ✅ Added for admin check

# ✅ Playforce command (Admin-Only)
@app.on_message(
    ...
    try:
        ...
        if chat_member.status not in ["administrator", "creator"]:
            return await message.reply_text(
                ...
                "🚨 **Warning! This command is restricted to admins only.** 🚨\n\n"
                "👿 **You dare to challenge the system, mortal?**\n"
                "😈 **First, become an admin… THEN use this command, Baby!** 🔥"
            )
    except RPCError as e:
        print(f"Error checking admin status: {e}")  # Debugging log
        return await message.reply_text("❌ Unable to check admin status! Make sure the bot is admin.")

    # If user is an admin, execute playforce
    await message.reply_text("✅ You are an admin, executing the playforce command...")
    # TODO: Add actual playforce logic here
